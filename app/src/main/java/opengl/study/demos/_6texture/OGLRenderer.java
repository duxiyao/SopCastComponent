...
public class OGLRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        ShaderProgram shader = new ShaderProgram(
                ShaderUtils.readShaderFileFromRawResource(context, R.raw.texture_vertex_shader),
                ShaderUtils.readShaderFileFromRawResource(context, R.raw.texture_frag_shader)
        );

        int textureName = TextureUtils.loadTexture(context, R.mipmap.razewarelogo_128);
