...
public abstract class DiffuseLightModel {
    ...
    public DiffuseLightModel(String name, ShaderProgram shader, float[] vertices, short[] indices) {
        this.name = name;
        this.shader = shader;
...
//        shader.disableVertexAttribute("a_Color");
    ...
    public abstract void injectData(ShaderProgram shader);
}
