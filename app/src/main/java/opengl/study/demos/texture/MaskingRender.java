...
public class MaskingRender implements GLSurfaceView.Renderer {
    ...
    public MaskingRender(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        ShaderProgram shader = new ShaderProgram(
                ...
                ShaderUtils.readShaderFileFromRawResource(context, R.raw.masking_frag_shader)
        );

        int zombieTexture = TextureUtils.loadTexture(context, R.mipmap.picture);
        int frameTexture = TextureUtils.loadTexture(context, R.mipmap.picture_frame);
        int maskTexture = TextureUtils.loadTexture(context, R.mipmap.picture_frame_mask);
