...
import opengl.study.demos.model.DiffuseLightModel;
import opengl.study.glkit.ShaderProgram;

public class DiffuseCube extends DiffuseLightModel {
    ...
    public DiffuseCube(ShaderProgram shader) {
        super("cube", shader, vertices, indices);
    }

    @Override
    public void injectData(ShaderProgram shader) {
