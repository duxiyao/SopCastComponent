...
public class SpecularRender implements GLSurfaceView.Renderer {
    ...
    public SpecularRender(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        ShaderProgram shader = new ShaderProgram(
                ShaderUtils.readShaderFileFromRawResource(context, R.raw.specular_vertex_shader),
                ShaderUtils.readShaderFileFromRawResource(context, R.raw.specular_frag_shader)
        );

        int textureName = TextureUtils.loadTexture(context, R.mipmap.dungeon_01);

        cube = new Cube2(shader);
